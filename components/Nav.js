                ...
                <div className="relative flex items-center justify-between h-16">
                    <div className="absolute left-0 inset-y-0 flex items-center sm:hidden">
                        ...
                        >
                            ...
                            --> */}
                            <svg id="hamburger" className={burger + " h-6 w-6"} xmlns="http://www.w3.org/2000/svg" fill="none"
                            ...
                            --> */}
                            <svg id="close" className={close + " h-6 w-6"} xmlns="http://www.w3.org/2000/svg" fill="none"
                                viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true">
                                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2"
                    ...
                    <div className="absolute right-0 inset-y-0 flex items-center pr-2 sm:static sm:inset-auto sm:ml-6 sm:pr-0">
                        ...
                        <div className="ml-3 relative">
                            ...
                            <div id="user-dropdown"
                                className={dropdown + " absolute origin-top-right right-0 mt-2 w-48 rounded-md shadow-lg py-1 bg-white ring-1 ring-black ring-opacity-5 focus:outline-none"}
                                role="menu" 
