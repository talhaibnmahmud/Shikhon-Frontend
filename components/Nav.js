                ...
                <div className="relative flex items-center justify-between h-16">
                    <div className="absolute left-0 inset-y-0 flex items-center sm:hidden">
                        ...
                        <button id="menu-toggle" type="button"
                            ...
                            --> */}
                            <svg id="hamburger" className="block h-6 w-6" xmlns="http://www.w3.org/2000/svg" fill="none"
                            ...
                            --> */}
                            <svg id="close" className="hidden h-6 w-6" xmlns="http://www.w3.org/2000/svg" fill="none"
                                viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true">
                                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2"
                    ...
                    <div className="flex flex-1 justify-center items-center sm:justify-start sm:items-stretch">
                        ...
                        <div className="hidden sm:block sm:ml-6">
                            <div className="flex space-x-4">
                                ...
                                <a href="#"
                                    className="text-gray-300 hover:bg-gray-700 hover:text-white block px-3 py-2 rounded-md text-base font-medium">Calender</a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="absolute right-0 inset-y-0 flex items-center pr-2 sm:static sm:inset-auto sm:ml-6 sm:pr-0">
                        ...
                        <div className="ml-3 relative">
                            ...
                            <div id="user-dropdown"
                                className="hidden absolute origin-top-right right-0 mt-2 w-48 rounded-md shadow-lg py-1 bg-white ring-1 ring-black ring-opacity-5 focus:outline-none"
