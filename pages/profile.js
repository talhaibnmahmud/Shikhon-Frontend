                ...
                <div className="md:flex no-wrap md:-mx-2">
                        ...
                        <div className="p-3 rounded-t-md border-t-4 border-indigo-600">
                            <div className="image overflow-hidden">
                                {/* <img className="h-auto w-full mx-auto rounded-md"
                                    ...
                                    alt="" /> */}
                                <img className="h-auto w-full mx-auto rounded-md" src="/profile.jfif" alt="Profile Image" />
                        </div>
                    ...
                    <div className="w-full md:w-9/12 md:mx-2">
                        ...
                        <div className="bg-white p-3 shadow-sm rounded-sm">
                            ...
                            <button
                                className="block my-4 w-full bg-indigo-600 text-white text-sm font-semibold rounded-lg hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 hover:shadow-xs">
                                    <Link href="/edit-profile">
                                    <a className="inline-block w-full h-full p-3">Edit Profile</a>
                                    </Link>
                            </button>
                        </div>
